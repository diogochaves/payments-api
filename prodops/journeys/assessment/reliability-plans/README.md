...
| Confirmação de pagamento | Entrou | `prodops/assessment/iteration-plans/iteration-plan.md`; `prodops/product/features/payment-confirmation.feature`; `AsaasWebhookController`; `InvoiceService.processProviderWebhook`. |
