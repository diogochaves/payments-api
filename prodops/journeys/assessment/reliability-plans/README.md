...
- `Criar invoice via Boleto` (`Entrou` — revisado 2026-07-06): OBC e BDD Feature já criados. Adicionar análise de risco completa neste Reliability Plan antes do Bootstrap.
