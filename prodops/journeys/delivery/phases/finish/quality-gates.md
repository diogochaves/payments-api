...
> **Fonte canônica do No Mocks Rule.** A definição técnica completa está em [`prodops/skills/hack/references/workflow.md § No Mocks Rule`](../../../../skills/hack/references/workflow.md). Este arquivo define o gate de enforcement — o que bloqueia merge.
