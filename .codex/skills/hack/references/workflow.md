...
HACK is the implementation phase. The agent repeats the work engineers did manually: branch, TDD, code, validation, commit.
...
- For this payments-api repository, read `.codex/skills/payments-api-local-testing/references/repository-standards.md` before changing payment behavior.
